...
class BenchCanvas(tk.Canvas):
    ...
    def redraw(self):
        ...
        self.create_rectangle(xl - 34, beam_y - 6, xl - 26, beam_y + 6,
                              fill="#2f343a", outline="")
        self.create_text(xl + 2, beam_y - 22, text="laser", fill="#4a5059",
        ...
        self.create_rectangle(xs - 4, beam_y - 5, xs + 4, beam_y + 5,
                              fill="#e9e7e2", outline="")
        self.create_text(xs, beam_y - 104, text="screen (hole)",
        ...
        self.create_text(xt, beam_y - 72, text="PMMA target", fill="#4d707a",
                         font=("TkDefaultFont", 8))
        ...
        self.create_text(12, 14, text="drag the screen or the target along the rail", anchor="w", fill="#8b8f96",
                         font=("TkDefaultFont", 8))
