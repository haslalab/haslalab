...
class BenchCanvas(tk.Canvas):
    ...
    def redraw(self):
        ...
        self.create_text(12, 14, text="drag the screen or the target along "
                                      "the rail", anchor="w", fill="#8b8f96",
                         font=("TkDefaultFont", 8))
        ...
        for k, d in self.T.items():
            ...
            if d["lab"]:
                self.create_text(d["x"] + 16, d["y"], text=d["lab"],
                                 ...
                                 font=("TkDefaultFont", 9, "bold"))
        if st["shorted"]:
            self.create_text(505, 536, text="the ammeter is across the laser: "
...
class App(tk.Tk):
    def __init__(self):
        ...
        ttk.Label(top, text="  APhO 2023  \u2013  Experimental Problem 2  "
                            "\u2013  Interference from a thermally deformed "
                            "surface", font=("TkDefaultFont", 11, "bold")
        ...
        ttk.Label(note, justify="left", wraplength=500, text=(
            "Turn the current knob with the mouse wheel, or click its left "
            "and right half.  Click the centre of the knob to switch "
            "between the coarse and the fine step.")
        ...
        self.lbl_cur = ttk.Label(
            ...
            text="ruler:  click the screen to read a radius, "
                 "drag to keep the mark")
    ...
    def set_cursor(self, r, held=False):
        ...
        self.lbl_cur.config(
            text="ruler:  R = %6.2f cm    D = %6.2f cm%s"
                 % (r, 2 * r, "   [marked]" if held else ""))
